class MechanicalLabyrinthTheme {
  constructor() {
    this.name = 'MechanicalLabyrinth Theme';
    this.description = 'A MechanicalLabyrinth themed dungeon environment';
    this.difficulty = 3;
...
module.exports = MechanicalLabyrinthTheme;
