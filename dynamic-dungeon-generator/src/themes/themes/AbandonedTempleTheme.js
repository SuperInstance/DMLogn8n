class AbandonedTempleTheme {
  constructor() {
    this.name = 'AbandonedTemple Theme';
    this.description = 'A AbandonedTemple themed dungeon environment';
    this.difficulty = 3;
...
module.exports = AbandonedTempleTheme;
